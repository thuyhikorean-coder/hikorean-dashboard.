...
function renderFunnel() {
    ...
    container.innerHTML = `
        ...
        <div style="display:grid; grid-template-columns: 1fr 1.1fr; gap: 8px; margin-bottom: 10px;">
            <div style="background:rgba(242,201,76,0.12); padding: 8px 10px; border-radius: 8px; border:1px solid rgba(242,201,76,0.25);">
                <div style="font-size:0.65rem; color:var(--text-muted); font-weight:600;">Mục tiêu DT New</div>
                <div style="font-size:1.05rem; font-weight:900; color:var(--primary); margin-top:2px;">${targetNewRevStr}</div>
            </div>
            <div style="background:rgba(242,201,76,0.18); padding: 8px 10px; border-radius: 8px; border:1px solid rgba(242,201,76,0.3);">
                <div style="display:flex; justify-content:space-between; align-items:center;">
                    <div style="font-size:0.65rem; color:var(--text-muted); font-weight:600;">Đơn New / Mục tiêu</div>
                    <div style="font-size:0.8rem; font-weight:900; color:${orderColor};">${orderProgress}%</div>
                </div>
                <div style="font-size:1.05rem; font-weight:900; color:${orderColor}; margin-top:2px;">${f.totalOrders} <span style="font-size:0.75rem; color:var(--text-muted); font-weight:600;">/ ${targetOrders} HV</span></div>
            </div>
        </div>
